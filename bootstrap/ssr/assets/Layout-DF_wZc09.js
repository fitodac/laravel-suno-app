...
import { u as useWindowWidth, t as templates, a as ProfileDropdown } from "./PageContent-ChVB5ffB.js";
...
const Layout = ({ children, pageTitle }) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "bg-background min-h-screen", children: [
      /* @__PURE__ */ jsx(Header, {}),
      /* @__PURE__ */ jsxs("div", { className: "flex justify-center min-h-svh", children: [
