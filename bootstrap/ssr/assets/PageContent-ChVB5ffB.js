...
const ProfileDropdown = ({
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(Dropdown, { radius: "none", placement: "bottom-end", children: [
    /* @__PURE__ */ jsx(DropdownTrigger, { className: "cursor-pointer select-none", children: showOnlyName ? /* @__PURE__ */ jsx("div", { children: `${user.name}` }) : showName ? /* @__PURE__ */ jsx(
      User,
      {
        isFocusable: true,
        name: user.name,
          ...
          /* @__PURE__ */ jsxs(DropdownSection, { showDivider: true, children: [
            showNameInDropdown ? /* @__PURE__ */ jsx(
              DropdownItem,
              {
                ...
                children: /* @__PURE__ */ jsx("span", { className: "text-xs text-foreground-500 font-medium", children: `${user.name} ${user.lastname}` })
              }
