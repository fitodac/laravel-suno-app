...
const translations = {
  en: {
    ...
    "Sorry, something went wrong on our servers.": "Sorry, something went wrong on our servers.",
    ...
    "This page you are looking for does not exsist": "This page you are looking for does not exsist %link%",
  ...
  es: {
    ...
    "Sorry, we are doing some maintenance. Please check back soon.": "Lo sentimos, estamos realizando mantenimiento. Por favor, vuelve a intentarlo más tarde.",
    "Sorry, something went wrong on our servers.": "Lo sentimos, algo salió mal en nuestros servidores.",
    "Sorry, the page you are looking for could not be found.": "Lo sentimos, no se pudo encontrar la página que buscas.",
    "Sorry, you are forbidden from accessing this page.": "Lo sentimos, no tienes permiso para acceder a esta página.",
    "This page you are looking for does not exsist": "La página que estás buscando no existe %link%",
...
const t = (str, params = {}) => {
  if (!str) return "";
  const translation = translations[locale][str];
  if (typeof translation === "string") {
    return Object.keys(params).reduce((acc, key) => {
      ...
      if (typeof value === "string") {
        ...
        return acc.split(new RegExp(`%${key}%`, "g")).flatMap(
          (item, i, arr) => i < arr.length - 1 ? [item, value] : item
        );
      }
    }, translation);
  }
