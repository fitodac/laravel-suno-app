						...
						<div className="w-3/5 space-y-6">
							{quota && (
								<div className="text-sm flex justify-between">
									<div className="">
										Créditos restantes {quota.credits_left}
									</div>
								</div>
							)}
							...
							>
								...
								<div className="mt-2 space-y-3 text-sm font-extralight">
									<div className="bg-gray-900 p-3 rounded-xl">
										Pop, Dance Pop, Ethereal, female vocals, catchy, eletronic,
										130 bpm, high quality production, perfect sounds
									</div>
									<div className="bg-gray-900 p-3 rounded-xl">
										Dance-pop, nostalgic, intimate, emotive male voice,Synth
										lead, bassline. high-quality production,perfect sounds,
										earworm
									</div>
								</div>
							</div>
